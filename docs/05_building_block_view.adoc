...
image::05_building_block_view.png[]
...
|BBDD|es donde se almacenan los datos de la aplicación.
|===
...
:imagesdir: images/
image:05_building_block_view2.jpeg[nivel2]
...
|====
| Nombre | Responsabilidad
| Capa de servicio o frontend| Consiste en las interfaces y vistas que se le mostrarán al usuario
| Capa de datos o backend| En esta capa se tratará con los datos de la aplicación.
|====

...
| _Eficiciencia_ | _La aplicación requerirá de unos mínimos de velocidad de carga, tanto como esté en mano del equipo de desarrollo. También proporcionará feedback al usuario durante los tiempos de carga._
|===
